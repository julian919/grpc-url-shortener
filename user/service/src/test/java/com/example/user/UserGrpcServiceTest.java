...
class UserGrpcServiceTest {
  ...
  @BeforeEach
  void setUp() {
    service = new UserGrpcService(registrationService);
  }

  @Test
  void register_success_delegatesToRegistrationServiceAndCompletes() {
    UUID principalId = UUID.randomUUID();
    when(registrationService.register("user@example.com", "secret123")).thenReturn(principalId);
    ...
    verify(registrationService).register("user@example.com", "secret123");
  }
}
